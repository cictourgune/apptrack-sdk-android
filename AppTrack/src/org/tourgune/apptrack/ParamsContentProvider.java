 ...
 */
public class ParamsContentProvider extends ContentProvider {
...
//		String s = getString(R.string.paramProvider);
//	}
...
//			"org.tourgune.apptrack.params";
    ...
    private static String initAuthority() {
        ...
        try {
            ...
            Field declaredField = clz.getDeclaredField("CONTENT_AUTHORITY_PARAMS");
	...
	public static final Uri CONTENT_URI= Uri.parse(CONTENT_PREFIX + AUTHORITY_PART + "/params");
	...
	private DatabaseParams dbHelper;
	...
	static
	{
		...
		URI_MATCHER.addURI(AUTHORITY_PART, "params", CODE_ALL_ITEMS);
		URI_MATCHER.addURI(AUTHORITY_PART, "params/#", CODE_SINGLE_ITEM);
	}
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		...
		{
		case CODE_ALL_ITEMS:
			rowsAffected = this.getOrOpenDatabase().delete(DatabaseParams.TABLE_NAMES, where, whereArgs);
			break;
		case CODE_SINGLE_ITEM:
			String singleRecordId = uri.getPathSegments().get(1);
			rowsAffected = this.getOrOpenDatabase().delete(DatabaseParams.TABLE_NAMES, DatabaseParams.CAMPO1 + "=" + singleRecordId, whereArgs);
			break;
		default:
	...
	public Uri insert(Uri arg0, ContentValues arg1) {
		// TODO Auto-generated method stub
		long rowID = getOrOpenDatabase().insert(DatabaseParams.TABLE_NAMES, DatabaseParams.DATABASE_NAME, arg1);
	...
	public boolean onCreate() {
		// TODO Auto-generated method stub
		dbHelper = new DatabaseParams(getContext());
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
		...
		qBuilder.setTables(DatabaseParams.TABLE_NAMES);
